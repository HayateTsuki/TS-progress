...
// This will give us inforamtion if object has a selected type.
// WARNING: instanceof only applies to objects and classes! Not interfaces!

console.log("\n--------Advanced Inheritance and casting in functions--------\n")

// We can use instanceof in function to check if obecjt is an instance of a class.
...
// Its possible to chnage type of an object.
