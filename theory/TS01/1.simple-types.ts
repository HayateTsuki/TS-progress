...
// but when TypeScript 'detects' type, then you can not chenge it!
// 💡TIP: This is recommended style in TypeScript

variableThatCanBeChanged = 42 // this is ok ✅ - same type (number) but different value

// follwoing code will throw error: Type 'string' is not assignable to type 'number'.ts(2322)
...
// but this is excessive - you dont have to do this in TypeScript
// it can be useful when:
// - you declare variable
// - do some operations
// - then you assign value

// its better to just assin value without writing type:
...
// it must be let because const will retun an error:
...
// you can check type of variable in different wyas.
